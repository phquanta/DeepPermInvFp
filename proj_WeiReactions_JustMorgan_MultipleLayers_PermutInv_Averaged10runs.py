...
#ff0=df_train['Mol2Vec'].to_numpy()
#ff00=df_test['Mol2Vec'].to_numpy()
...
def MT_model(perm):
    ...
    def funx1(i,maxL):
     ...
     if i<maxL:
         return Input(shape=(767,),name=f"MoR_{i}")
...
#    x2_1=Concatenate()([x2[0],x2[1],x2[2]])
 ...
 #   list2=[112,112,112,112]    
    pairwise_model = pl.PairwiseModel(
        (767,), pl.repeat_layers(Dense, list1, name="hidden",activation='relu'), name="pairwise_model"
    )
